...
function AddReview({ onAddReview }: AddReviewProps) {
  ...
  return (
    <div className="mt-12 border-t pt-10">
      <h2 className="text-2xl font-bold text-gray-800 mb-6">Dejar una reseña</h2>

      <div className="mb-6">
        <label className="block font-semibold text-gray-700 mb-3">Calificación</label>
      ...
      <div className="mb-6">
        <label className="block font-semibold text-gray-700 mb-3">Comentario</label>
