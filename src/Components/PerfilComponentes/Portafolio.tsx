{/* Sección del Portafolio: Cuadrícula de proyectos */}
  <section className="bg-white py-12 px-4 md:px-12 max-w-7xl mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      {/* Tarjeta de Proyecto Individual (Repetible por cada trabajo) */}
      <div className="relative rounded-2xl overflow-hidden shadow-md bg-[#1d61a1] group aspect-[4/3]">
        {/* Imagen de fondo del trabajo realizado */}
        <img 
          src="" 
          alt="Breter" 
        ...
        {/* Capa de texto inferior con degradado oscuro para legibilidad */}
