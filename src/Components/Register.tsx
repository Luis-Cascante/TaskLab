...
function Register({ onChangeLogin, onRegisterSuccess }: RegisterProps) {
      ...
      <div className="min-h-screen w-full flex flex-col md:flex-row font-sans">
        ...
        <section className="flex-1 bg-[#e5e7eb] flex flex-col items-center justify-center px-8 py-12 md:px-24">
          <div className="w-full max-w-sm">
            ...
            <form
              action="/guardar-datos.php"
              method="POST"
              className="flex flex-col gap-4"
            >
              {/* Campo Nombre */}
              <div className="flex flex-col gap-1">
                <label htmlFor="nombre" className="text-sm text-gray-600 ml-1">
                  Nombre completo
                </label>
                <input
                  type="text"
              ...
              {/* Campo Correo */}
              <div className="flex flex-col gap-1">
                <label htmlFor="correo" className="text-sm text-gray-600 ml-1">
                  Correo electrónico
                </label>
                <input
                  type="email"
              ...
              {/* Campo Cédula */}
              <div className="flex flex-col gap-1">
                <label htmlFor="cedula" className="text-sm text-gray-600 ml-1">
                  Cedula
                </label>
                <input
                  type="text"
