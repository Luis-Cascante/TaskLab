...
export interface WorkInfoResponse extends WorkInfo {
    portfolio_items: PortfolioItem[];
    reviews: Review[];
}

export interface UserDBAnwer {
    id: string;
    name: string;
    email: string;
    identification_number: string;
...
//     phone: "8888-8888",
//     password: "123456",
//     profile_picture: "https://picsum.photos/id/58/600/600",
