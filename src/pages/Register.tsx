        ...
        <section className="flex-1 bg-[#e5e7eb] flex flex-col items-center justify-center px-8 py-12 md:px-24">
          <div className="w-full max-w-sm">
            ...
            <form action="/guardar-datos.php" method="POST" className="flex flex-col gap-4">
              ...
              {/* Campo dirreccion */}
              <div className="flex flex-col gap-1">
                <label htmlFor="direccion" className="text-sm text-gray-600 ml-1">Dirección</label>
                <input 
                  type="text" 
                  id="direccion" 
                  name="direccion" 
              ...
              {/* Campo Telefono */}
              <div className="flex flex-col gap-1">
                <label htmlFor="phone" className="text-sm text-gray-600 ml-1">Número de teléfono</label>
                <input 
                  type="text" 
                  id="phone" 
                  name="phone" 
